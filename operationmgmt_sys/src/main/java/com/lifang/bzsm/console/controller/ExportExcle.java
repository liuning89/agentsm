...
public class ExportExcle extends BaseController {
    ...
    public String download(HttpServletRequest request, HttpServletResponse response, LfBzAgentReportRequest req) throws IOException {
        ...
        // 填充projects数据
        List<BusinessReport> projects = createData(req, employee);
        List<Map<String, Object>> list = createExcelRecord(projects,req);
        String columnNames[] = {"日期", "区域", "门店", "行程量", "平均行程量", "带盘", "带客", "悟空找房", "网络", "其它", "新增总数", "发布", "钥匙", "速销", "实景","无效审核数量", "房源"
                , "客户", "营销指数", "分享房源次数", "分享房源套数", "好评", "差评"};
        String keys[] = {"日期", "区域", "门店", "行程量", "平均行程量", "带盘", "带客", "悟空找房", "网络", "其它", "新增总数", "发布", "钥匙", "速销", "实景","无效审核数量", "房源"
                , "客户", "营销指数", "分享房源次数", "分享房源套数", "好评", "差评"};

        String columnNamessum[] = {"区域", "门店", "行程量", "平均行程量", "带盘", "带客", "悟空找房", "网络", "其它", "新增总数", "发布", "钥匙", "速销", "实景","无效审核数量", "房源"
                , "客户", "营销指数", "分享房源次数", "分享房源套数", "好评", "差评"};
        String keyssum[] = {"区域", "门店", "行程量", "平均行程量", "带盘", "带客", "悟空找房", "网络", "其它", "新增总数", "发布", "钥匙", "速销", "实景","无效审核数量", "房源"
                , "客户", "营销指数", "分享房源次数", "分享房源套数", "好评", "差评"};
    ...
    private List<BusinessReport> createData(LfBzAgentReportRequest req, LfEmployee emp) {
        ...
        response = bizReportService.getStoreBizReport(req);

        return response.getData() == null ? null : (List<BusinessReport>) response.getData();
    }

    private List<Map<String, Object>> createExcelRecord(List<BusinessReport> projects, LfBzAgentReportRequest req) {
        List<Map<String, Object>> listmap = new ArrayList<Map<String, Object>>();
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("sheetName", "sheet1");
        listmap.add(map);
        BusinessReport project = null;
