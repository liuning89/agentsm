 ...
 *
 */
package com.lifang.bzsm.console.utils;
...
public class OrgCodeUtil {
     ...
     * @return
     */
    public static List<Integer> getEmployeeIdsByOrgCode(String code, AgentSOAServer server, LfAreaOrgReadMapper lfAreaOrgReadMapper, Employee employee) {
     ...
     * @return
     */
    public static List<Integer> getEmployeeIdsByOrgIds(Integer cityOrgId, Integer areaOrgId, Integer storeOrgId, AgentSOAServer server, LfAreaOrgReadMapper lfAreaOrgReadMapper,  LfEmployee employee) {

        List<Integer> resultList = null;
        List<Agent> agents = null;

        PositionInfo info = server.getEmployeePositionInfo(employee.getId(), SystemInfo.OperationManagementSystem);
        com.lifang.agentsoa.model.Employee soaemp = server.getEmployee(employee.getId(), SystemInfo.OperationManagementSystem);

        Integer wpid = soaemp.getFranchiseeId();
     ...
     * @return
     */
    public static List<Integer> getStoreListByEmployeeId(Integer cityId, Integer areaId, AgentSOAServer server, Employee employee)
    {
        AreaOrgModel model = server.getEmployeeAreaOrgsMap(employee.getId(), SystemInfo.BusinessManagementSystem);
     ...
     * @return
     */
    public static List<Integer> getAreadListByEmployeeId(Integer cityId, AgentSOAServer server, Employee employee)
    {
        AreaOrgModel model = server.getEmployeeAreaOrgsMap(employee.getId(), SystemInfo.BusinessManagementSystem);
     ...
     * @return
     */
    public Map<String, List<AreaOrg>> getCityAreaStoreListByEmployeeList(AgentSOAServer server, Employee employee)
    {
        AreaOrgModel model = server.getEmployeeAreaOrgsMap(employee.getId(), SystemInfo.BusinessManagementSystem);
     ...
     * @return
     */
    public Map<String, List<Integer>> getCityAreaStoreIdByEmployeeList(AgentSOAServer server, Employee employee)
    {
        /**
         * 获取城市详情
         */
     ...
     * @return
     */
    public static boolean isAgent(AgentSOAServer server, Employee employee)
    {
