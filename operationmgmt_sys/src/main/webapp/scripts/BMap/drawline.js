...
(function() {
    ...
    DrawingManager.prototype._initialize = function(map, opts) {
        ...
        this.polylineDBLClickFn = opts.polylineDBLClickFn || {};
        //ck添加
        this.undoFn = opts.undoFn || {};
     ...
     * 设置当前的绘制模式
     * @param {DrawingType}
     * @description points是ck加上去的，只在画线的模式上有作用
     */
     ...
     */
    DrawingManager.prototype._bindPolylineOrPolygon = function(points1) {
            ...
            if (points.length == 1) {
               if (me._drawingType == BMAP_DRAWING_POLYLINE) {
                    ...
                    if(!overlay){
	                    ...
	                    document.addEventListener('keyup',keybordAction);
                    }
        ...
        //在画线的时候监听esc、delete键来实现撤销
        var keybordAction = function(e){
        	if(e.keyCode == 27 || e.keyCode == 46){
	        	...
	        	if(points.length>0){
		            ...
		            if(document.removeEventListener){
		            	document.removeEventListener("keyup",keybordAction,false);
		            }
	            	drawPoint.length = 0;
	            	me.close();
        ...
        var dblclickAction = function (e) {
        	var goon = true;
        	if(typeof(me.polylineDBLClickFn) == "function"){
        		goon = me.polylineDBLClickFn.call(null,e,me);
        	}
        	if(goon){
        		baidu.stopBubble(e);
	            isBinded = false;
    ...
    DrawingTool.prototype._generalHtml = function(map){
        ...
        // html.push(getItem("BMapLib_box BMapLib_undo", "undo"));
    ...
    DrawingTool.prototype._bindEventByDraingMode = function(drawingType){
        ...
        if (drawingType == "hander") {
        ...
        } else if (drawingType == "undo"){
        	var hasPolygon = false;
        	for(var i = 0;i<me.drawingModes.length;i++){
	        	if(me.drawingModes[i] == "polyline"){
	        		hasPolygon = true;
	        		break;
	        	}
        	}
        	if(hasPolygon){
        		var points;
        		if(typeof(drawingManager.undoFn) == "function"){
	        		points = drawingManager.undoFn.call(null,me);
	        	}
        		drawingManager.open();
        		drawingManager.setDrawingMode("polyline",points);
