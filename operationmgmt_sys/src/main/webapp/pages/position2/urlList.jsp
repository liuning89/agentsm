...
<html>
				...
				<tr>
					...
					<td>
						<div id="dg2" class="mini-datagrid" style="width:550px;height:450px;" showCheckBox="true"
							multiSelect="true" url="<%=basePath%>position/getPositionPriFunctions2.do" showPager="false">
							<div property="columns">
								<div type="checkcolumn" width="10"></div>
								<div header="ID" field="id" width="10"></div>
								<div header="功能名称" field="name" width="30"></div>
	...
	<script type="text/javascript" src="scripts/pages/position2/urlList.js"></script>
</html>