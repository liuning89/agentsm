...
<body >
    <div id="housefollowUpDiv" style="padding-bottom:5px;">
     <span>城市:</span>
      ...
      onvalidation="onComboValidation" onvaluechanged="onCityChanged" emptyText="请选择" nullItemText="请选择" />
        ...
        <div id="repetitionimage" name="repetitionimage" class="mini-checkbox" checked="true" readOnly="false" text="描述过于简单" ></div><br/>
        <div id="shamimage" name="shamimage" class="mini-checkbox" checked="true"  readOnly="false" text="描述与实际有偏差"></div><br/>
        <div id="lowpixel" name="lowpixel" class="mini-checkbox" checked="true" readOnly="false" text="虚假描述"></div><br/>
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:100%;" 
        ...
        <div property="columns">
            ...
            <div field="sellPoint" width="100" align="center" headerAlign="center">卖点内容</div>
            <div field="beAccusationAgentId" width="120" renderer="onEvaluateBad" align="center" headerAlign="center"  allowSort="false">录入人</div>  
            ...
            <div field="auditor" width="100" headerAlign="center"  align="center" allowSort="false">操作</div>
    ...
    <script type="text/javascript">
       ...
       /*  	if(field == "imgKey"){
        ...
        function search() {
            ...
            grid.load({ cityCode:cityCode,accusationType: 1, accusationReasonId: accusationReasonId, auditSatus: status});
        }
