...
<body >
    <div style="padding-bottom:5px;">
        ...
        <input id="corporate" type="text" class="mini-textbox" />
    ...
    <script type="text/javascript">
        ...
        grid.on("drawcell", function (e) {
        	...
        	if(field == "context"){
       		 	...
       		 	e.cellHtml = "<a href='javascript:void(0)' onclick='openToShow(\"" + record.id+ "\")'>查看</a>&nbsp&nbsp&nbsp<a href='javascript:void(0)' onclick='editData(\"" + record.id+ "\")'>编辑</a>";
        		 	
        	}
        	
        	if(field == "contextstore"){
       		 	
       		 	e.cellHtml = "<a href='javascript:void(0)' onclick='openStoreShow(\"" + record.tid+ "\")'>查看</a>";
        ...
        function search() {
            ...
            grid.load({ cityId: cityId, corporate: corporate, corporatephone: corporatephone, repetitionimage: repetitionimage});
        }
