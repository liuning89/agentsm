...
<div   id="form">
    ...
    <input id="agentId" name="agentId" class="mini-combobox" style="width:135px;"
           ...
           url="${ctx}/agent/getAgentByStoreOrg.action?orgCode=000" allowInput="true"
    ...
    <div id="dg" class="mini-datagrid" style="height:100%;" pageSize='100' sizeList="[20,30,50,100]"
        ...
        <div property="columns">
            ...
            <div header="接单" headerAlign="center" align="center">
                <div property="columns">
                    <div field="orderAllocation" headerAlign="center" align="center" width="50">人工派单
                    </div>
                    <div field="orderAllocationNew" headerAlign="center" align="center" width="50">系统派单（新单）</div>
                    <div field="orderAllocationOld" headerAlign="center" align="center" width="50">系统派单（老单）
                    </div>
                    <div field="orderGrab" headerAlign="center" align="center" width="50">抢单</div>
                    <div field="orderTotal" headerAlign="center" align="center" width="50">总单</div>
                    <div field="orderCustomer" headerAlign="center" align="center" width="50">客户</div>
                </div>
            </div>
            <div header="出价数" headerAlign="center" align="center">
                <div property="columns">
                    <div field="orderSuccess" headerAlign="center" align="center" width="50">确认出价
                    </div>
                    <div field="orderFailed" headerAlign="center" align="center" width="50">撤销出价
                    </div>
                    <div field="priceTotal" headerAlign="center" align="center" width="50">总数</div>
                </div>
            </div>
        </div>
    </div>
