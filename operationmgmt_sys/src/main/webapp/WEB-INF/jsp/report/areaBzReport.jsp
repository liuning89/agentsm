...
<body path="<%=basePath%>">
    ...
    <div style="padding-bottom: 10px;">
        ...
        <span>区域:</span>
        <input id="areaId" class="mini-combobox" style="width:135px;" textField="name" valueField="code" 
...
<script type="text/javascript">
	...
	function search(){
		...
		grid.load({cityCode:cityId,areaCode:areaId,dateStart:dateStart,dateEnd:dateEnd,queryType:queryType});
	}
    ...
    function downLoadExcel()
    {
    	...
    	window.location.href = "${ctx}/areaexportExcle/download_excel.action?cityCode="
                + cityId + "&areaCode=" + areaId  + "&dateStart=" + dateStart + "&dateEnd=" + dateEnd+ "&queryType="+queryType;
    }
