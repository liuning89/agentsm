...
<div   id="form">
    ...
    <input id="title" name="title" class="mini-textbox" value="经纪人接单出价情况" style="display: none;">
...
<div id="agentReportDiv" class="mini-fit" style="height:400px">
    <div id="dg" class="mini-datagrid" style="height:100%;" pageSize='100' sizeList="[20,30,50,100]"
         url="${ctx}/bizsimpreport/getAgentBizSimpReport.action">
            ...
            <div header="基本信息" headerAlign="center" align="center">
                <div property="columns">
                    ...
                    <div field="statisticsDate" name="statisticsDate" renderer="onTimeRenderer" headerAlign="center"
                         align="center" width="60">日期
                    </div>
                    <div field="areaOrgName" headerAlign="center" align="center" width="60">区域</div>
                    <div field="storeOrgName" headerAlign="center" align="center" width="60">门店</div>
                    <div field="agentName" headerAlign="center" align="center" width="60">经纪人</div>
                </div>
            </div>
            <div header="接单" headerAlign="center" align="center">
                <div property="columns">
                    <div field="orderAllocationHand" headerAlign="center" allowSort="true"  align="center" width="50">人工派单
                    </div>
                    <div field="orderGrab" headerAlign="center" align="center" allowSort="true"  width="50">抢单</div>
                    <div field="orderAllocationNew" headerAlign="center" allowSort="true"  align="center" width="50">系统派单（新单）</div>
                    <div field="orderAllocationOld" headerAlign="center" allowSort="true"  align="center" width="50">系统派单（老单）
                    </div>
                    <div field="orderTotal" headerAlign="center" align="center" allowSort="true"  width="50">总单</div>
                    <div field="orderCustomer" headerAlign="center" align="center" allowSort="true"  width="50">客户</div>
                </div>
            </div>
            <div header="出价数" headerAlign="center" align="center">
                <div property="columns">
                    <div field="orderSuccess" headerAlign="center" align="center" allowSort="true"  width="50">确认出价
                    </div>
                    <div field="orderFailed" headerAlign="center" align="center" allowSort="true"  width="50">撤销出价
                    </div>
                    <div field="priceTotal" headerAlign="center" align="center" allowSort="true"  width="50">总数</div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" language="javascript" charset=UTF-8">
    ...
    function exportExcel() {
        ...
        window.location.href = encodeURI(encodeURI("${ctx}/bizsimpreport/exportAgentBizSimpReport.action?title=" + title + "&data=" + data + "&dateStart=" + dateStart + "&dateEnd=" + dateEnd));
    }
